	...
	$(document).ready( function() {
		...
		$('#searchWord').keydown(function(key){
			if(key.keyCode == 13){
				...
				// location.href = "/pr/cliplist?page="+ page + "&langCd="+ langCd + "&fuelCd="+fuelCd+"&searchWord="+searchWord;
				location.href = "/pr/cliplist?page=1&langCd="+ langCd + "&fuelCd="+fuelCd+"&searchWord="+searchWord;
			}
		});
...
function getPrMgntInfo(){
	...
	var param = {"prClipSeqId" : 1 , "langCd" : langCd }
