...
public class TbNotice {
    ...
    @Builder
    public TbNotice(Long seqNo, String menuCd, String typeCd, String title, String content, LocalDateTime strtDt, LocalDateTime endDt, LocalDateTime cretDtm, LocalDateTime mdfyDtm, String img, LocalDateTime regDate) {
        this.seqNo = seqNo;
        this.menuCd = menuCd;
        this.typeCd = typeCd;
        this.title = title;
